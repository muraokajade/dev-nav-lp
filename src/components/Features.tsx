...
export const Features: React.FC = () => (
  <Section id="features" className="pt-14 pb-24">
    {/* 見出し */}
    <div className="mb-10">
    ...
    {/* コード・ショーケース */}
    <div className="mt-16"> {/* ← 縦余白を広げた */}
      <div className="text-xs uppercase tracking-[.2em] text-sky-300/80 mb-2">
        Code Highlight
      </div>
      <h2 className="text-xl md:text-2xl font-extrabold text-white">
        Markdown のコードは
        <strong className="text-sky-400">美しく読みやすく</strong>
        表示
      </h2>
      <p className="mt-3 text-gray-300">
        ReactMarkdown + Prism ベースで、行番号・コピー・長⾏折返しに対応。
        実際の記事と同じ見え方でプレビューできます。
      </p>
